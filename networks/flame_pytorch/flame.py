...
class FLAME(nn.Module):
    ...
    def forward(
        ...
        # print(f"shape_betas params: {self.shape_betas.shape}")
        # print(f"expression params: {expression_params.shape}")
        # print(f"expression_betas params: {self.expression_betas.shape}")
        betas = torch.cat(
